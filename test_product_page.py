...
define_link = "http://selenium1py.pythonanywhere.com/catalogue/coders-at-work_207/"
...
def test_guest_cant_see_success_message(browser):
    page = ProductPage(browser, url=define_link)
    page.open()
...
define_link = "http://selenium1py.pythonanywhere.com/en-gb/catalogue/the-city-and-the-stars_95/"


def test_guest_should_see_login_link_on_product_page(browser):
    page = ProductPage(browser, define_link)
    page.open()
